 ...
 */
public class TmallShopItemDetailCrawlerModule extends TmallShopItemCrawlerModule{
	private static Logger log = LoggerFactory.getLogger(TmallShopItemDetailCrawlerModule.class);
	private final static String DEFAULT_JOB_NAME = TmallShopItemDetailCrawlerModule.class.getSimpleName();
