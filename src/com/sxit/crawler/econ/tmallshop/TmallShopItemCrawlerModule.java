package com.sxit.crawler.econ.tmallshop;
...
import com.sxit.crawler.econ.tmallshop.process.TmallItemDataProcess;
import com.sxit.crawler.econ.tmallshop.process.TmallShopItemCrawlerProcess;
 ...
 */
public class TmallShopItemCrawlerModule extends CrawlModule{
	private static Logger log = LoggerFactory.getLogger(TmallShopItemCrawlerModule.class);
	private final static String DEFAULT_JOB_NAME = TmallShopItemCrawlerModule.class.getSimpleName();
	...
	public void execute() {
		...
		tmallItemDatatableConfig = initDatatableConfig("shoptmallitem_datatable_config.xml");
		...
		for (String shopHref : shopHrefs) {
			try {
				...
				TmallShopItemCrawlerProcess TmallShopItemCrawlerProcess = 
						new TmallShopItemCrawlerProcess(USER_AGENT_PROVIDER, this, crawlConfig);
		...
		TmallItemDataProcess tmallItemDataProcess = new TmallItemDataProcess(USER_AGENT_PROVIDER, this, crawlConfig);
		Map<String, Object> param = new HashMap<String, Object>();
